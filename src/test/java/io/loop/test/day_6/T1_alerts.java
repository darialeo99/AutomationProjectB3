...
public class T1_alerts extends TestBase {
    ...
    public void informationAlert() {
        ...
        Alert alert = driver.switchTo().alert(); // creating object of the Alert
        alert.accept();
    ...
    public void confirmationAlert() {
        driver.get("https://loopcamp.vercel.app/javascript-alerts.html");
        WebElement clickForJSComfirm = driver.findElement(By.xpath("//button[.='Click for JS Confirm']"));
        clickForJSComfirm.click();

        driver.switchTo().alert().accept(); // not creating the object of Alert, directly using it here // will click ok and accept the alert
    ...
    public void promptAlert () {
        ...
        driver.get("https://loopcamp.vercel.app/javascript-alerts.html");
        WebElement clickJSScriptPrompt = driver.findElement(By.xpath("//button[.='Click for JS Prompt']"));
        clickJSScriptPrompt.click();
