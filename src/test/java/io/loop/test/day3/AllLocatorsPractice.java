...
public class AllLocatorsPractice {
    public static void main(String[] args) {
        ...
        // navigate to loopcamp practice
        // original page https://loopcamp.vercel.app

        driver.get("https://loopcamp.vercel.app/registration_form.html"); // going to registration page
...
//        withClassName.sendKeys("Academy");
